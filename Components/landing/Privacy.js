...
function Privacy() {
  return (
    <div className={`${styles.privacyPolicy} max-w-4xl mx-auto`}>
      <div className="sectionTitle mb-10">
        <h3 className="text-xl md:text-3xl font-bold capitalize text-gray-800 mb-6">
          Privacy policy
        </h3>
        <p className="text-base text-gray-500 leading-7 my-4">
          This Privacy Policy governs the manner in which the website collects,
          ...
          Site and all products and services offered by company.
        </p>
      </div>
      <div className={`max-w-4xl mx-auto ${styles.policies}`}>
        ...
        <p>
          ...
          email address. Users may, however, visit our Site anonymously. We will
        ...
        <p>
          Company has the discretion to update this privacy policy at any time.
