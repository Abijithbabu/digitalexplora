...
export default function LicenseModal(props) {
  ...
  const [frontImage, setfrontImage] = useState(person.drivingFront);
  const [backImage, setbackImage] = useState(person.drivingBack);
  ...
  return (
    <Modal>
      <div className="flex items-center justify-between">
        <div className="mb-2 text-gray-700 text-2xl">Edit License Details</div>
        <button
      ...
      <form action="#">
        <div className="mb-4">
          ...
          <input
            ...
            defaultValue={person.drivingLicense}
