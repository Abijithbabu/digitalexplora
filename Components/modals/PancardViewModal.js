...
function PancardViewModal({ showModal, setShowModal, kyc }) {
    ...
    <>
      <Transition.Root show={showModal} as={Fragment}>
        <Dialog
          ...
          open={showModal}
          onClose={() => setShowModal({ panCardModal: false })}
        >
                    ...
                    <div className="mt-3 text-center sm:text-left">
                      ...
                      >
                        ...
                        <button
                          ...
                          onClick={() => setShowModal({ panCardModal: false })}
                          ref={cancelButtonRef}
                        >
                          <XMarkIcon />
                        </button>
                      ...
                      {kyc ? (
                        <div className="mt-4">
                          <div className="mb-4">
                            <label htmlFor="">Pancard No.</label>
...
export default PancardViewModal;
