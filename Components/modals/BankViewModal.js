...
function BankViewModal({ showModal, setShowModal, kyc }) {
    ...
    <>
      <Transition.Root show={showModal} as={Fragment}>
        <Dialog
          ...
          open={showModal}
          onClose={() => setShowModal({ bankModal: false })}
        >
                    ...
                    <div className="mt-3 text-center sm:text-left">
                      ...
                      >
                        ...
                        <button
                          ...
                          onClick={() => setShowModal({ aadharModal: false })}
                          ref={cancelButtonRef}
                        >
                          <XMarkIcon />
                        </button>
                      ...
                      {kyc ? (
                        <div className="mt-4">
                          ...
                          <div className="mb-4">
                            <label htmlFor="frontImage">Bank Name:</label>
                            <h3 className="text-lg text-gray-600 font-bold flex items-center capitalize">
                              <BuildingOffice2Icon className="mr-2 w-6 h-6 text-blue-600" />
                              {kyc.bankAccount.bankName}
                            </h3>
                          </div>
                          <div className="mb-4">
                            <label htmlFor="frontImage">Bank Statement:</label>
                            <h3 className="text-lg text-gray-600 font-bold">
                              <PictureAsPdf
                                color="secondary"
                                className="mr-2"
                              />
                              {kyc.bankAccount.bankStatementName}
                            </h3>
                          </div>
                        </div>
                      ) : (
